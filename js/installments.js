...
function printInstNewLabel(){
  ...
  waitForJsBarcode(()=>{
    ...
    try{
      ...
      const html = `<div style="width:210mm;height:297mm;display:flex;justify-content:flex-start;align-items:flex-start;padding:0 30mm 0 0;box-sizing:border-box;margin-top:-4mm">
      <div style="direction:rtl;font-family:Arial,sans-serif;width:80mm;padding:2mm 2.5mm 0 1.5mm;box-sizing:border-box;text-align:center">

        <!-- رأس اللوجو -->
        <div style="display:flex;align-items:center;justify-content:center;gap:8px;margin-bottom:3mm;padding-bottom:2mm;border-bottom:2px dashed #1a2a5e">
          <div style="font-size:22px;font-weight:900;color:#1a2a5e;letter-spacing:1px">SJ STORE</div>
        </div>

        <!-- البيانات -->
        <div style="font-size:16px;font-weight:900;margin-bottom:2.3mm;color:#1a2a5e;text-align:center">${i.customerName}</div>
        <div style="font-size:14px;font-weight:700;margin-bottom:2.2mm;color:#333;text-align:center">${i.productName}</div>
        <div style="font-size:14px;font-weight:700;margin-bottom:1.8mm;text-align:center"><b>\u0627\u0644\u0645\u0628\u0644\u063a:</b> ${fmt(i.totalPrice)}</div>
        <div style="font-size:14px;font-weight:700;margin-bottom:1.8mm;text-align:center"><b>\u0627\u0644\u0645\u062f\u0641\u0648\u0639:</b> ${fmt(i.paid)}</div>
        <div style="font-size:14px;font-weight:700;margin-bottom:1.8mm;text-align:center"><b>\u0627\u0644\u0645\u062a\u0628\u0642\u064a:</b> ${fmt(i.remaining)}</div>
        <div style="font-size:12.5px;font-weight:600;margin-bottom:1.8mm;color:#555;text-align:center"><b>\u062a\u0627\u0631\u064a\u062e \u0627\u0644\u062f\u0641\u0639:</b> ${dateStr}</div>
        <div style="font-size:12.5px;font-weight:600;margin-bottom:3mm;color:#555;text-align:center"><b>\u0627\u0644\u062f\u0641\u0639\u0629 \u0627\u0644\u0642\u0627\u062f\u0645\u0629:</b> ${nextDateStr}</div>

        <!-- خط فاصل -->
        <div style="border-top:2px solid #1a2a5e;margin-bottom:2mm"></div>

        <!-- الباركود -->
        <div style="display:flex;justify-content:center">${svgHtml}</div>

        <!-- خط فاصل -->
        <div style="border-top:2px solid #1a2a5e;margin-top:2mm;padding-top:2mm;border-bottom:2px dashed #1a2a5e;padding-bottom:2mm">
          <div style="font-size:17px;font-weight:900;color:#1a2a5e;text-align:center">\u0628\u0627\u0644\u062a\u0642\u0633\u064a\u0637</div>
        </div>
...
function printInstInfo(){
  ...
  const html = `<div style="direction:rtl;font-family:Arial,sans-serif;padding:4mm 3mm 0 2mm;text-align:right;width:65mm;margin-right:30mm">
