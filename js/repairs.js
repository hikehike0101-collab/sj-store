...
function printRepairNewLabel(){
  ...
  waitForJsBarcode(()=>{
    ...
    const html = `<div style="width:210mm;height:297mm;display:flex;justify-content:flex-start;align-items:flex-start;padding:0 30mm 0 0;box-sizing:border-box;margin-top:-4mm">
      <div style="direction:rtl;font-family:Arial,sans-serif;width:81mm;padding:2mm 2.5mm 0 1.5mm;box-sizing:border-box;text-align:center">
...
function printRepairInfo(){
  ...
  const d = new Date(r.date);
  const dateStr = `${d.getDate()}/${d.getMonth()+1}/${d.getFullYear()}`;
  const html = `<div style="direction:rtl;font-family:Arial,sans-serif;padding:4mm 3mm 0 2mm;margin:0;text-align:right;width:65mm">
